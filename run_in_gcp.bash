...
python3.6 main.py --shutdown --gcp_bucket jupyter-data-for-sf --stages_to_run vectors tfidf --cores_to_use -1 --input_folder ../codes/ --output_folder results_8_6_19 > logfile.txt 2>&1
sudo shutdown
# ls -la results
# df -h
# shutdown -c
